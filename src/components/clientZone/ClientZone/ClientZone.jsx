...
function ClientZone({profile}) {
  ...
  function signOut(event){
    Navigate(<ClientzoneRegister/>)
}
  // const [profile, setprofile] = useState({data:ClientzoneRegister});

  //  const data=  profile.data()
  const loader = useSelector((state) =>state.emailAddress.isloader)
  ...
  return  (
    <div className=" container page-header noBackground">
      <div>
     {loader ? <Spinner animation="border" role="status" className="container d-flex align-items-center justify-content-center">
          ...
          <div className="col-xs-12 col-sm-12 col-md-4">
            <div className=" clientZoneProfileImage box-primary box-text-primary text-center" >
              <div className="profile-image " style={{ position: 'relative' }}>
                <img className='prof-image' id="profileImagePreview" src={profile.picture ?`${profile.picture}`:`https://cdn-cms-s.f-static.net/versions/2/wizard/clientZone/images/noImage.png`} data-src="https://cdn-cms-s.f-static.net/versions/2/wizard/clientZone/images/noImage.png"/>
                <div className="s123-uploader">
                  <div className="s123-u-upload-btn"><i className="bi bi-camera hidden" data-icon-name="camera" style={{}} alt="camera" >&nbsp;</i>
                  </div>
              ...
              <div className='clientemail'>
                <span className="email fw-bold d-block mb-2">{profile.email}</span>
                <i class="bi-box-arrow-in-right fw-bold  logoutBtn border  p-2" onClick={(e)=>signOut(e)}>&nbsp; logout</i>
              </div>
            </div>
            ...
            <div id="clientZone-menu-tabs" className="box-primary clientZoneTabs mb-3">
