          ...
          <div className="side-cart-body">
            {count <= 0 ? (
              ...
              {cart.map((product)=>{
                ...
                <div>
                  <Link to={`/order`}>
                    <button className="btn btn-custom btn-lg w-100 m-3" id="orderBtn">MAKE AN OREDER</button>
                  </Link>
                </div>
                <button className="btn btn-custom btn-lg w-100 m-3"id="continueBtn"> CONTINUE SHOPPING</button>
              </div>
            )}
